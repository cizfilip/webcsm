...
namespace webcsm.Models
{
    ...
    public interface IMembershipService
    {
        ...
        MembershipUser GetUser(IAuthenticationResponse response);
    }
    ...
    public class AccountMembershipService : IMembershipService
    {
        ...
        public MembershipUser GetUser(IAuthenticationResponse response)
        {
            return _provider.GetUser(response.ClaimedIdentifier, true);
        }
